  ...
  <div class="user-page-wrapper">
    <div class="g-container">
      <div class="user-create">
        <h1 class="title">Редактировать пользователя ( {{ username }} )</h1>
            ...
            <div class="tab-content">
              <div class="content-item">
                <div class="form-item">
                  ...
                  <input class="form-input" :class="{'error' : !username, 'opacity-50': !authUserIsAdmin}" type="text" v-model="username" :disabled="!authUserIsAdmin">
                  <p v-show="!username" class="message-error">Это поле обязательно к заполнению</p>
                </div>
                <div class="form-item">
                  <label class="form-label">Полное имя*</label>
                  <input class="form-input" :class="{'error' : !full_name, 'opacity-50': !authUserIsAdmin}" type="text" v-model="full_name" :disabled="!authUserIsAdmin">
                  <p v-show="!full_name" class="message-error">Это поле обязательно к заполнению</p>
                </div>
                <div class="form-item-wrapper">
                  <div class="form-item">
                    <label class="form-label">Телефон*</label>
                    <input class="form-input" :class="{'error' : !phone_number, 'opacity-50': !authUserIsAdmin}" type="tel" v-model="phone_number" :disabled="!authUserIsAdmin">
                    <p v-show="!phone_number" class="message-error">Это поле обязательно к заполнению</p>
                  </div>
                  <div class="form-item">
                    <label class="form-label">E-mail*</label>
                    <input class="form-input" :class="{'error' : !email, 'opacity-50': !authUserIsAdmin}" type="email" v-model="email" :disabled="!authUserIsAdmin">
                ...
                <div class="form-item">
                  ...
                  <div class="form-select-wrapper">
                    <template>
                      <el-select
                        :disabled="roleId === adminRoleId || !authUserIsAdmin"
                ...
                <div class="form-item">
                  ...
                  <ul class="region-list" :class="{'opacity-50' : roleId === adminRoleId}">
                    <li class="region-list__item" v-for="selectedRegion in selectedBusinessRegions" v-bind:key="selectedRegion.id">
                      ...
                      <div v-if="roleId !== adminRoleId && authUserIsAdmin" class="cursor-pointer" @click="removeSelectedRegion(selectedRegion.id)">
              ...
              <div class="content-item">
                <div class="form-item">
                  ...
                  <template>
                    <el-select
                      ...
                      class="form-select"
                      :class="{'error' : roleId === null, 'opacity-50': !authUserIsAdmin}">
                      <el-option
                        class="form-option"
                        v-for="role in roles"
                        :key="role.id"
                ...
                <div class="form-item">
                  <input id="active" class="form-input-check"
                         :class="{'opacity-50': !authUserIsAdmin}"
                         type="checkbox" v-model="is_active" :disabled="!authUserIsAdmin">
  ...
  export default {
      ...
      methods: {
          ...
          async fetchUser(id) {
            ...
            this.selectedBusinessRegionIds = user.regions;
          ...
          async updateUser() {
              ...
              await this.$services.UserService.updateUser(user);
              this.$services.MessageService.success('Пользователь успешно обновлён');
          },
      ...
      computed: {
          ...
          authUserIsAdmin() {
              return this.authUser.role === this.adminRoleId;
          },
          adminRoleId() {
...
/*  top: 16px;*/
/*  right: 10px;*/
/*  background: url("../../assets/images/svg/down-white.svg") no-repeat;*/
/*  width: 16px;*/
/*  height: 10px;*/
/*  z-index: 2;*/
/*  cursor: pointer;*/
