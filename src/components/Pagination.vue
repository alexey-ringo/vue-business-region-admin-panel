  ...
  <div class="pagination">
    ...
    <ol class="pagination-list">
      <li class="pagination-list__item active">
        <div class="pagination-list__link">{{ currentPage }}</div>
      </li>
      <li class="pagination-list__item" @click="onPrevious">
        <div :class="{'pagination-arrow--disabled': !isPreviousUsersPage}"
          class="pagination-arrow pagination-arrow-left"></div>
      </li>
      <li class="pagination-list__item" @click="onNext">
        <div :class="{'pagination-arrow--disabled': !isNextUsersPage}"
          class="pagination-arrow pagination-arrow-right"></div>
      </li>
    </ol>
    <p class="pagination-count">из <span>{{ totalPages }}</span></p>
  </div>
</template>
...
.pagination-arrow {
  width: 10px;
  height: 10px;
  border-top: 2px solid #DD0060;
  border-right: 2px solid #DD0060;
  /*margin-right: 60px;*/
}
